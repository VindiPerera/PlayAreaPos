  ...
  >
    ...
    <div class="w-full md:w-5/6 py-12">
      ...
      <div class="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
        <p class="text-gray-600 mb-6">Update the package details</p>
...
const form = reactive({
  ...
  base_time_minutes: props.package.base_time_minutes,
  extra_charge: props.package.extra_charge,
  extra_charge_per_minutes: props.package.extra_charge_per_minutes,
  age_threshold: props.package.age_threshold,
  additional_payment: props.package.additional_payment || "",
...
const submitForm = () => {
  ...
  router.put(route("packages.update", props.package.id), form, {
    onError: (err) => {
